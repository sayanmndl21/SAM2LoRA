...
class G1020Dataset(BaseSegmentationDataset):
    def __init__(
        self,
        data_dir: str,
    ...
    def load_data(self, random_state: int = 0) -> List[Dict[str, Any]]:
        ...
        for image_path in all_images:
            ...
            mask_base_path: str = os.path.join(self.data_dir, "Images")
            if os.path.exists(os.path.join(mask_base_path, mask_name)):
                im_dict: Dict[str, Any] = {"image": image_path,
...
if __name__ == "__main__":
    ...
    data_dir: str = os.path.join(basepath, "datasets", "eye_dataset", "Fundus", "G1020")
    dataset = G1020Dataset(data_dir, dataset_type='train', unified=False, transform=None)